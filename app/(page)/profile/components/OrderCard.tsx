...
interface OrderCardProps {
    ...
    onViewDetail?: (order: OrderData) => void;
...
export default function OrderCard({
    ...
    const [reviewTarget, setReviewTarget] = useState<OrderItemData | null>(
        null,
    );
    ...
    const isOnlinePaymentMethod = ["online", "ewallet"].includes(
        order.paymentMethod,
    );
                            ...
                            <div className="flex flex-col gap-3 border-t border-stone-100 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-5">
                                ...
                                <div className="flex flex-wrap justify-end gap-2">
                                    <button
                                        ...
                                        className="min-w-24 cursor-pointer border border-stone-200 bg-white px-5 py-2 text-sm font-medium text-stone-700 transition hover:border-orange-300 hover:text-orange-600"
                                    >
                                        Chi tiết
                                    </button>
